...
public ref class MultiUsersInterface : public sigverse::SIGService  
{  
	
public:
	MultiUsersInterface(System::String^ name) : SIGService(name)
	{
...
MultiUsersInterface::~MultiUsersInterface()  
{  
  this->disconnect();  
}  

int MultiUsersInterface::getScore()
{
...
int MultiUsersInterface::getTotal()
{
	return m_total;
}
System::String^ MultiUsersInterface::getMessage()
{
...
int MultiUsersInterface::getScoreSize()
{
	return tmp_score->Count;
}

double MultiUsersInterface::onAction()  
{  
  return 10.0;  
}  

void MultiUsersInterface::onRecvMsg(sigverse::RecvMsgEvent ^evt)  
{  
